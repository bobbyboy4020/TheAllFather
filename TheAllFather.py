...
reportSaveLoc = r"C:\Users\hkarn\Documents\PDF\FreshReports\Oct 17 - Oct 28"
dontClose = False
jobCodes = []
copy = ""
jobsRB = ""
...
def PrintPopUp():
	...
	while True:
		if(reg.exists("SavePDF-FileAs.png")):
			break
		else:
			if(Screen(0).exists(Pattern("popUpSaveAs.png").similar(0.88))):
				Screen(0).click("popUpSaveAs.png")
			elif(Screen(0).exists("BSave.png")):
				Screen(0).click("BSave.png")
...
def SaveCardsRetake(codes, eeApp, first, eeReg, sortType): #after exe made, make subject not photographed and save to jobs folder
	...
	sleep(0.1)
	if ("h" in sortType):
		eeReg.click("Homeroom-Alpha.png")
	elif ("g" in sortType):
		eeReg.click("Grade-Alpha.png")
	elif ("a" in sortType):
		eeReg.click("Alpha-Sort.png")
	else:
		if(codes[1]=="E231"):
			eeReg.click("Homeroom-Alpha.png")
		elif(codes[1]=="H231"):
